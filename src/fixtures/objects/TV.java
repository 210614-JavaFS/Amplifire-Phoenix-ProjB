...
public class TV extends Fixture implements Interactive {
	...
	public void Interact(Player player) {
		...
		System.out.println("You turn the TV on and the screen illuminates. It's a real estate show! They're showing this young couple around the kitchen of a house.");
	}
}
